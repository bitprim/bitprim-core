...
//  */
// #ifndef LIBBITCOIN_MACHINE_PROGRAMV2_HPP_
// #define LIBBITCOIN_MACHINE_PROGRAMV2_HPP_
...
//     /// This can only run individual operations via run(op, programv2).
//     programv2();

//     /// Create an instance that does not expect to verify signatures.
//     /// This is useful for script utilities but not with input validation.
//     /// This can run ops via run(op, programv2) or the script via run(programv2).
//     programv2(const chainv2::script& script);

//     /// Create an instance with empty stacks (input run).
//     programv2(const chainv2::script& script, const chainv2::transaction& transaction, uint32_t input_index, uint32_t forks);

//     /// Create using copied forks and copied stack (prevout run).
//     programv2(const chainv2::script& script, const programv2& other);

//     /// Create using copied forks and moved stack (p2sh run).
//     programv2(const chainv2::script& script, programv2&& other, bool move);

//     /// Constant registers.
//     bool is_valid() const;
//     uint32_t forks() const;
//     uint32_t input_index() const;
//     const chainv2::transaction& transaction() const;
...
//     const chainv2::script& script_;
//     const chainv2::transaction& transaction_;
...
// #include <bitcoin/bitcoin/impl/machine/programv2.ipp>

// #endif // LIBBITCOIN_MACHINE_PROGRAMV2_HPP_
