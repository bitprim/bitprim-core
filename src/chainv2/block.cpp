...
//  */
// #include <bitcoin/bitcoin/chainv2/block.hpp>
...
// #include <bitcoin/bitcoin/chainv2/compact.hpp>
// #include <bitcoin/bitcoin/chainv2/input_point.hpp>
...
// block::block(const chainv2::header& header, const transaction::list& transactions)
//     : header_(header), transactions_(transactions), validation{}
// {}

// // TODO: deal with possibility of inconsistent merkle root in relation to txs.
// block::block(chainv2::header&& header, transaction::list&& transactions)
...
//     auto const to = [&sink](const transaction& tx) { tx.to_data(sink); };
//     std::for_each(transactions_.begin(), transactions_.end(), to);
// }

// hash_list block::to_hashes() const {
//     auto const to_hash = [](const transaction& tx) { return tx.hash(); };
...
//     auto const sum = [](size_t total, const transaction& tx) {
...
// chainv2::header& block::header() {
//     return header_;
// }

// const chainv2::header& block::header() const {
//     return header_;
// }
...
// void block::set_header(const chainv2::header& value) {
//     header_ = value;
// }

// // TODO: see set_header comments.
// void block::set_header(chainv2::header&& value) {
...
// chainv2::block block::genesis_mainnet() {
//     data_chunk data;
//     decode_base16(data, encoded_mainnet_genesis_block);
//     auto const genesis = chainv2::block::factory_from_data(data);
...
// chainv2::block block::genesis_testnet() {
//     data_chunk data;
...
//     auto const value = [bip16_active](size_t total, const transaction& tx) {
...
// code block::accept_transactions(chain::chain_state const& state) const {
//     code ec;
...
// code block::connect_transactions(chain::chain_state const& state) const {
//     code ec;
...
// code block::accept(chain::chain_state const& state, bool transactions) const {
...
// code block::connect(chain::chain_state const& state) const {
